 ...
 */
public class PiEstimatorKrb extends Configured implements Tool {
  /** tmp directory for input/output */

  private static final Logger sLogger = Logger.getLogger(PiEstimatorKrb.class);

/**  static private Path TMP_DIR = new Path( PiEstimatorKrb.class.getSimpleName() + "/" + "_TMP_" + randNum); */
  public static Path TMP_DIR;

  public PiEstimatorKrb(String path) {

    TMP_DIR = new Path( path );
  ...
  public int run(String[] args) throws Exception {
    ...
    sLogger.info("Estimated value of Pi is "
